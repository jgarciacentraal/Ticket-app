                        ...
                        <div className="col-md-4">
                            <div className="card">
                                ...
                                <form className="card-body">
                                    ...
                                    <div className="form-group">
                                        <textarea type="text" className="form-control" rows="8" cols="80"
                                            placeholder="Message.." name="message" 
                                            onChange={this.handleChange} value={this.state.message}/>
                                    </div>
                                    <div className="form-group">
                                        <button className="btn btn-outline-primary" type="submit" onClick={this.sendTicket} >Enviar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                    ...
                                    this.state.tickets.map(ticket => {
                                        return (
                                            <tr key={ticket._id}>
                                                ...
                                                <td>
                                                    <button style={{ margin: "5px" }} onClick={() => this.editTicket(ticket._id)}>
                                                        Edit
                                                    </button>
